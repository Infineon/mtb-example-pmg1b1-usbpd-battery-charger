...
APPNAME=mtb-example-pmg1b1-usbpd-battery-charger
...
DEFINES=CY_PD_SINK_ONLY=1 CY_PD_SOURCE_ONLY=0 CY_PD_REV3_ENABLE=1 CY_PD_CBL_DISC_DISABLE=1 \
        ...
        DEFINES+=VCONN_OCP_ENABLE=0 VCONN_SCP_ENABLE=0
PDSTACK_DEFINES=CY_PD_VCONN_DISABLE=0 CY_USE_CONFIG_TABLE=0\
        CY_PD_BIST_MODE_DISABLE=0 CY_PD_EPR_ENABLE=0 CY_PD_CRC_ERR_HANDLING_ENABLE=1

USBPD_DEFINES=CCG_CF_HW_DET_ENABLE=1 PMG1B1_USB_CHARGER=1

FAULT_DEFINES=DISABLE_CC_OVP_OVER_SLEEP=0 BB_ILIM_DET_ENABLE=1\
        VREG_BROWN_OUT_DET_ENABLE=1 VREG_INRUSH_DET_ENABLE=1 PDL_VOUTBB_RCP_ENABLE=1

CHARGING_DEFINES=BATTERY_CHARGING_ENABLE=1 LEGACY_PD_PARALLEL_OPER=0 QC_AFC_CHARGING_DISABLED=1 \
        QC_SRC_AFC_CHARGING_DISABLED=1
...
SOLUTION_DEFINES=VBUS_CTRL_TRIM_ADJUST_ENABLE=1 VBUS_CTRL_TYPE_P1=4 CY_PD_VBUS_CF_EN=1\
        ...
        IBTR_ENABLE=1 CCG_PD_BLOCK_ALWAYS_ON=1 BB_PWM_ASYNC_MODE_ENABLE=0 \
